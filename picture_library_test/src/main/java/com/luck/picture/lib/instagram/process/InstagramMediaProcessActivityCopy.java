...
// * ================================================
// */
//public class InstagramMediaProcessActivityCopy extends PictureBaseActivity {
...
//            ((LifecycleCallBack)((ViewGroup)container).getChildAt(0)).onStart(InstagramMediaProcessActivityCopy.this);
//        }
//    }
//
//    @Override
...
//        super.onResume();
//        if (container != null && ((ViewGroup)container).getChildAt(0) instanceof LifecycleCallBack) {
//            ((LifecycleCallBack)((ViewGroup)container).getChildAt(0)).onResume(InstagramMediaProcessActivityCopy.this);
//        }
//    }
//
//    @Override
...
//        super.onPause();
//        if (container != null && ((ViewGroup)container).getChildAt(0) instanceof LifecycleCallBack) {
//            ((LifecycleCallBack)((ViewGroup)container).getChildAt(0)).onPause(InstagramMediaProcessActivityCopy.this);
//        }
//    }
//
//    @Override
...
//        super.onDestroy();
//        if (container != null && ((ViewGroup)container).getChildAt(0) instanceof LifecycleCallBack) {
//            ((LifecycleCallBack)((ViewGroup)container).getChildAt(0)).onDestroy(InstagramMediaProcessActivityCopy.this);
//        }
//    }
//
//    @Override
...
//                    ((ProcessStateCallBack)contentView.getChildAt(0)).onBack(InstagramMediaProcessActivityCopy.this);
//                }
//            }
//
//            @Override
...
//                if (contentView != null && contentView.getChildAt(0) instanceof ProcessStateCallBack) {
//                    ((ProcessStateCallBack)contentView.getChildAt(0)).onCenterFeature(InstagramMediaProcessActivityCopy.this, view);
//                }
//            }
//
//            @Override
...
//                if (contentView != null && contentView.getChildAt(0) instanceof ProcessStateCallBack) {
//                    ((ProcessStateCallBack)contentView.getChildAt(0)).onProcess(InstagramMediaProcessActivityCopy.this);
//                }
//            }
//        });
//    }
...
//            ((ProcessStateCallBack)((ViewGroup)container).getChildAt(0)).onBack(InstagramMediaProcessActivityCopy.this);
//        }
//    }
//
//    @Override
...
//        if (container != null && ((ViewGroup)container).getChildAt(0) instanceof ProcessStateCallBack) {
//            ((ProcessStateCallBack)((ViewGroup)container).getChildAt(0)).onActivityResult(InstagramMediaProcessActivityCopy.this, requestCode, resultCode, data);
//        }
//    }
//
...
//        Intent intent = new Intent(activity.getApplicationContext(), InstagramMediaProcessActivityCopy.class);
