 ...
 * ================================================
 */
public class InstagramMediaProcessActivityCopy1 extends AppCompatActivity {
...
//        }
        ...
        colorPrimary = ContextCompat.getColor(this, R.color.purple_500);
        initWidgets();
...
//            ((LifecycleCallBack)((ViewGroup)container).getChildAt(0)).onStart(InstagramMediaProcessActivityCopy1.this);
        }
    }
    ...
    protected void onResume() {
        super.onResume();
        if (container != null && ((ViewGroup)container).getChildAt(0) instanceof LifecycleCallBack) {
//            ((LifecycleCallBack)((ViewGroup)container).getChildAt(0)).onResume(InstagramMediaProcessActivityCopy1.this);
        }
    }
    ...
    protected void onPause() {
        ...
        super.onPause();
        if (container != null && ((ViewGroup)container).getChildAt(0) instanceof LifecycleCallBack) {
//            ((LifecycleCallBack)((ViewGroup)container).getChildAt(0)).onPause(InstagramMediaProcessActivityCopy1.this);
        }
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (container != null && ((ViewGroup)container).getChildAt(0) instanceof LifecycleCallBack) {
//            ((LifecycleCallBack)((ViewGroup)container).getChildAt(0)).onDestroy(InstagramMediaProcessActivityCopy1.this);
        }
    }
...
//        mTitleBar = new InstagramTitleBar(this, mPictureSelectionConfig, mMediaType);
...
//                    ((ProcessStateCallBack)contentView.getChildAt(0)).onBack(InstagramMediaProcessActivityCopy1.this);
                }
            }
            ...
            public void onCenterViewClick(ImageView view) {
                if (contentView != null && contentView.getChildAt(0) instanceof ProcessStateCallBack) {
//                    ((ProcessStateCallBack)contentView.getChildAt(0)).onCenterFeature(InstagramMediaProcessActivityCopy1.this, view);
                }
            }
            ...
            public void onRightViewClick() {
                if (contentView != null && contentView.getChildAt(0) instanceof ProcessStateCallBack) {
//                    ((ProcessStateCallBack)contentView.getChildAt(0)).onProcess(InstagramMediaProcessActivityCopy1.this);
                }
            }
        });
    }
...
//            ((ProcessStateCallBack)((ViewGroup)container).getChildAt(0)).onBack(InstagramMediaProcessActivityCopy1.this);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (container != null && ((ViewGroup)container).getChildAt(0) instanceof ProcessStateCallBack) {
//            ((ProcessStateCallBack)((ViewGroup)container).getChildAt(0)).onActivityResult(InstagramMediaProcessActivityCopy1.this, requestCode, resultCode, data);
        }
    }
...
//        InstagramMediaMultiImageContainer multiImageContainer = new InstagramMediaMultiImageContainer(this, mPictureSelectionConfig, selectMedia, isAspectRatio);
...
//        InstagramMediaSingleVideoContainer singleVideoContainer = new InstagramMediaSingleVideoContainer(this, mPictureSelectionConfig, selectMedia.get(0), isAspectRatio);
//        contentView.addView(singleVideoContainer, FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT);
    ...
    private void createSingleImageContainer(FrameLayout contentView) {
        ...
        try {
            ...
            InstagramMediaSingleImageContainer singleImageContainer = new InstagramMediaSingleImageContainer(this, mPictureSelectionConfig, bitmap, isAspectRatio, selectionFilter);
    ...
    public static void launchActivity(Activity activity, PictureSelectionConfig config, List<LocalMedia> images, Bundle extras, int requestCode) {
        Intent intent = new Intent(activity.getApplicationContext(), InstagramMediaProcessActivityCopy1.class);
