...
public class InstagramMediaMultiImageContainer extends FrameLayout implements InstagramFilterAdapter.OnItemClickListener, MediaAdapter.OnItemClickListener, ProcessStateCallBack {
    ...
    private InstagramFilterAdapter mFilterAdapter;
    private List<Bitmap> mBitmaps;
    private View mMediaLoadingView;
    private View mFilterLoadingView;
    ...
    public InstagramMediaMultiImageContainer(@NonNull Context context) {
        super(context);
    }

    public InstagramMediaMultiImageContainer(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public InstagramMediaMultiImageContainer(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
