...
import com.kuanquan.picture_test.config.OnCustomCameraInterfaceListener;
import com.kuanquan.picture_test.config.OnResultCallbackListener;
import com.kuanquan.picture_test.config.OnVideoSelectedPlayCallback;
import com.kuanquan.picture_test.config.PictureConfig;
import com.kuanquan.picture_test.config.PictureCropParameterStyle;
import com.kuanquan.picture_test.config.PictureParameterStyle;
import com.kuanquan.picture_test.config.PictureWindowAnimationStyle;
import com.kuanquan.picture_test.config.UCropOptions;
...
//    public static ImageEngine imageEngine;
    ...
    protected void initDefaultValue() {
        chooseMode = PictureConfig.TYPE_VIDEO;
        camera = false;
        themeStyleId = 0;
        ...
        buttonFeatures = 0x103;  //初始化按钮为可录制可拍照
