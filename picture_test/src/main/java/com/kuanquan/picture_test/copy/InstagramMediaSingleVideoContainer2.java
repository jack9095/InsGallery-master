 ...
 */
public class InstagramMediaSingleVideoContainer2 extends FrameLayout implements ProcessStateCallBack, LifecycleCallBack {
    ...
    public InstagramMediaSingleVideoContainer2(@NonNull Context context, LocalMedia media, boolean isAspectRatio) {
        super(context);
        mMedia = media;
